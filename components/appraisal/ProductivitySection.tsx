...
export function ProductivitySection({
  ...
  if (loading) {
    return <p style={{ color: "#8a97b8", padding: "16px 0" }}>Loading productivity assessment…</p>;
  }
      ...
      >
        ...
        <div style={{ padding: "20px 24px 16px", borderBottom: "1px solid #dde5f5", display: "flex", alignItems: "center", justifyContent: "space-between", gap: "10px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            <div style={{ width: "32px", height: "32px", borderRadius: "9px", background: "#f0fdfa", display: "flex", alignItems: "center", justifyContent: "center", color: "#0d9488" }}>
              <TrendingUpIcon />
            </div>
            <div>
        ...
        {factors.length === 0 ? (
          <div style={{ padding: "32px 24px", textAlign: "center" }}>
            <p style={{ color: "#8a97b8", fontSize: "13px" }}>
              No productivity factors configured. Contact HR to set up evaluation factors.
            </p>
          </div>
        ) : (
